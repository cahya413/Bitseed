...
<body>
    ...
    <div class="container-fluid page-header py-5 mb-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container text-center py-5">
            <h1 class="display-3 text-white mb-4 animated slideInDown">Sayur</h1>
    ...
    // Query untuk mengambil data dari tabel tbltanaman hanya untuk kategori "Buah"
    $sql = "SELECT id_tanaman, nama, kategori, deskripsi, persiapan, penanaman, perawatan, gambar FROM tbltanaman WHERE kategori = 'Buah'";
    ...
    if ($result->num_rows > 0) {
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            echo '            <a class="btn btn-sm" href="buah_detail.php?id=' . $id_tanaman . '"><i class="fa fa-plus text-primary me-2"></i>Lebih Lanjut</a>';
            echo '        </div>';
            echo '    </div>';
            echo '</div>';
        }
